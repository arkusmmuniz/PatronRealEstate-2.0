...
export default function NELAPropertiesPage() {
  return (
        ...
        <div className="bg-gradient-to-r from-lime-50 to-green-50 rounded-lg p-6 mb-8 border-2 border-lime-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-lime-600 mb-1">$750,000</div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">Cultural Hub</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-lime-200">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              ...
              your perfect property in this vibrant cultural community.
            </p>
            <Link href="/contact">
