...
import { ArrowLeft, MapPin, Home, Mountain } from "lucide-react";
import Link from "next/link";
import Image from "next/image";

export default function TujungaPropertiesPage() {
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 bg-lime-100 rounded-full flex items-center justify-center">
              <Mountain className="w-6 h-6 text-lime-600" />
            </div>
            <div>
              ...
              <p className="text-gray-600 flex items-center gap-2 mt-1">
                ...
                Explore homes in Tujunga
              </p>
            </div>
          </div>
          
          <p className="text-gray-600 max-w-3xl">
            Discover beautiful properties in Tujunga, a tight-knit community nestled in the foothills, 
            known for its quiet charm and strong community connection.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-lime-50 to-green-50 rounded-lg p-6 mb-8 border-2 border-lime-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-lime-600 mb-1">$850,000</div>
              <div className="text-sm text-gray-600">Avg Home Price</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-lime-600 mb-1">27,000</div>
              <div className="text-sm text-gray-600">Residents</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-lime-600 mb-1">🌄</div>
              <div className="text-sm text-gray-600">Mountain Views</div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          <IDXBrokerWidget 
            widgetId="121633" 
            title="Available Properties in Tujunga" 
          />
        </div>
