...
export default function ShadowHillsPropertiesPage() {
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900">
                Shadow Hills Properties
              </h1>
              <p className="text-gray-600 flex items-center gap-2 mt-1">
                <MapPin className="w-4 h-4" />
                Explore homes in Shadow Hills
              </p>
            </div>
          </div>
          
          <p className="text-gray-600 max-w-3xl">
            Discover exceptional properties in Shadow Hills, a semi-rural atmosphere with deep equestrian tradition, 
            offering wide streets and pastoral scenery perfect for those seeking a unique lifestyle.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-lime-50 to-green-50 rounded-lg p-6 mb-8 border-2 border-lime-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-lime-600 mb-1">$1,200,000</div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">Equestrian Lifestyle</div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          <IDXBrokerWidget 
            widgetId="121634" 
            title="Available Properties in Shadow Hills" 
          />
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-lime-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-3">
              Ready to Find Your Home in Shadow Hills?
            </h3>
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Contact Fabiola Patron for personalized guidance and expert assistance in finding 
              your perfect property in this unique equestrian community.
            </p>
            <Link href="/contact">
